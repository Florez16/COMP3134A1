...
function checkAnswer(cats, multiplier) {
    ...
    if (result) { // case: correct -> show tick image
        document.getElementById("result_img").innerHTML = '<img src="resources/correct.jpg" width="200" height="200">';
    }
    else {       // case: wrong -> show cross image
        document.getElementById("result_img").innerHTML = '<img src="resources/wrong.jpg" width="200" height="200">';
    }
