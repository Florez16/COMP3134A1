...
function checkAnswer(cats, multiplier) {
    ...
    userAnswer = parseInt(document.getElementById("get_ans").value);
    ...
    if (result) { // case: correct -> alert user that he / she is correct
        window.alert("Congratulations! You are correct!");
    }
    else {       // case: wrong -> alert user that he / she is wrong
        window.alert("Sorry! You did not answer correctly!");
    }
